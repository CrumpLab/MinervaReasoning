...
3. The order of inference questions is **not yet randomized**, mainly owing to the way I used jsPsych to achieve differing numbers of inference questions within each trial. I suppose my first step will be to implement randomization in R.
