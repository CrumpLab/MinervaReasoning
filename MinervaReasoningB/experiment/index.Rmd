...
general_design <- data.frame(stringsAsFactors=FALSE,
                       premise_one = c("A+", "A+", "A-", "A-", 
                                       "AB+", "AB-", "AB+", "AB-", 
                                       "A+","A-", "AB+", "AB-", "C+", "C-", 
                                       "C+","C+", "C-", "C-", 
                                       "AB+", "AB-", "AB+","AB-"),
                       premise_two = c("AB+", "AB-", "AB+", "AB-", 
                                       "A+", "A+", "A-", "A-", 
                                       NA,NA, NA, NA, NA, NA, 
                                       "AB+", "AB-", "AB+","AB-", 
                                       "C+", "C+", "C-", "C-"),
                     question_type = c("experimental", "experimental", "experimental",
                                       ...
                                       "control", "control", "control", "control",
                                       "control", "control", "control"),
                     overall_premise = c("A+AB+","A+AB-","A-AB+","A-AB-",
                                         "A+AB+","A+AB-","A-AB+","A-AB-",
                                         "A+","A-", "AB+", "AB-", "C+", "C-",
                                         "C+AB+","C+AB-","C-AB+","C-AB-",
                                         "C+AB+","C+AB-","C-AB+","C-AB-"
...
for(i in 1:dim(general_design)[1]){
  ...
  rand_q_order <- sample(1:4)
  general_design$q1[i] <- all_questions[rand_q_order[1]]
  general_design$q2[i] <- all_questions[rand_q_order[2]]
  general_design$q3[i] <- all_questions[rand_q_order[3]]
  general_design$q4[i] <- all_questions[rand_q_order[4]]
  general_design$q1_type[i] <- rand_q_order[1]
  general_design$q2_type[i] <- rand_q_order[2]
  general_design$q3_type[i] <- rand_q_order[3]
  general_design$q4_type[i] <- rand_q_order[4]
...
library(xprmntr)
stimulus_json <- stimulus_df_to_json(general_design[1:22,],
                       stimulus= "stimulus",
                       data = c("premise_one","premise_two",
                                "question_type", "overall_premise",
                                "p1_outcome","p2_outcome",
                                "p1_sentence","p2_sentence",
                                "q1","q2","q3","q4","trial_number",
                                "q1_type","q2_type","q3_type","q4_type"))
...
var face_name_procedure = {
    timeline: [
        ...
        },
        {
            ...
            on_finish: function(){
             jsPsych.data.get().addToLast({question_order: 'q1'});
            }
        },
        {
            type: 'html-slider-response',
            ...
            on_finish: function(){
             jsPsych.data.get().addToLast({question_order: 'q2'});
            }
        },
        {
            type: 'html-slider-response',
            ...
            on_finish: function(){
             jsPsych.data.get().addToLast({question_order: 'q3'});
            }
        },
        {
            type: 'html-slider-response',
            ...
            on_finish: function(){
             jsPsych.data.get().addToLast({question_order: 'q4'});
            }
        }
    ],
